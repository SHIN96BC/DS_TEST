...
public class CalculateHelper {
    ...
    public String sorted(String reNumber) {
        ...
        ArrayList<String> bracket = new ArrayList<String>();  //괄호 포함
        ...
        if (bracket.size() != 0) {                              //괄호 배열 정렬
            ArrayList<String> resultList5 = new ArrayList<String>();              //괄호 곱셈 나눗셈
            ArrayList<String> resultList6 = new ArrayList<String>();              //괄호 덧셈 뺄셈
    ...
    public String merge(ArrayList value){
        ...
        ArrayList<String> markNum = new ArrayList<String>();        //부호 + 숫자가 함께 들어있는 배열
